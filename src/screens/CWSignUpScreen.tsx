...
type CWSignUpScreenNavigationProp = StackNavigationProp<AuthStackParamList, 'CWSignUp'>;

const CWSignUpScreen = () => {
  const navigation = useNavigation<CWSignUpScreenNavigationProp>();
  const colors = useColors();

  return (
    <View style={[styles.container, { backgroundColor: colors.primary_background }]}>
      <Text style={[styles.title, { color: colors.primary_80 }]}>CW Sign Up Screen</Text>
