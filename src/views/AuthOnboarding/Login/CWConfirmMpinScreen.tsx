...
import { NavigationStackData, navigationBeanObj, ActionType, navigateTo } from "../../../navigation/CWNavGraph";
        ...
        (scrollY: Animated.Value) => {
            return (
                <View style={styles.container}>
                    ...
                    {showMpinSuccessPopup && (
                        <MPINSuccessPopup visible={showMpinSuccessPopup} />
                    )}
                </View>
            );
        }
